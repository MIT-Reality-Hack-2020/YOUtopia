# Oringianl resource: https://github.com/Emotiv/cortex-v2-example
# Thank you!
...
user = {
	"license" : "42e8732b-32fe-458c-86fc-d44f1a261185",
	"client_id" : "46QZ1k6YRMPlqqzCo1F8gX7DrvY7dkdvSakQycNG",
	"client_secret" : "SuQdo2FnKjy2qBSp6MBIGhuC2L7uspJ8kGE5UHk4tOUZtSMhLweYXvXOusfx7hcCCFNs0wSMkZWHaCu9AG2VwqN6NovXEOAZ6hWZdprC9HQJFogakTK8pinwHFnGGv4U",
	"debit" : 100,
	"number_row_data" : 10
}
...
# export parameter
record_export_folder = 'C:\\MITHack\\YOUtopia\\EEG'
...
cmd = 'python C:\\MITHack\\YOUtopia\\python\\Data_process.py'
os.system(cmd)
# ---------------------------------------------------